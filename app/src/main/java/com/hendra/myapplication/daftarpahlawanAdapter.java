...
public class daftarpahlawanAdapter  extends ArrayAdapter<Pahlawan> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (tr.getAsal().equals(Pahlawan.JAKARTA)) {
            viewHolder.txasal.setText("JAKARTA");
        } else if (tr.getAsal().equals(Pahlawan.BOGOR)) {
            viewHolder.txasal.setText("BOGOR");
        } else if (tr.getAsal().equals(Pahlawan.JAWA)) {
